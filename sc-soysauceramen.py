...
def get_output_dir_path():
    ...
    output_dir_path = os.path.join(BASE_DIR, "output_soysauceramen")
...
# 醤油ラーメン
driver.get("https://www.photo-ac.com/main/search?q=%E9%86%A4%E6%B2%B9%E3%83%A9%E3%83%BC%E3%83%A1%E3%83%B3&srt=dlrank")
...
wb.save('soysauceramen_excel1.xlsx')
wb.close()