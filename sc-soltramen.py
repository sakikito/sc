...
def get_output_dir_path():
    ...
    output_dir_path = os.path.join(BASE_DIR, "output_soltramen")
...
# 塩ラーメン
driver.get("https://www.photo-ac.com/main/search?q=%E5%A1%A9%E3%83%A9%E3%83%BC%E3%83%A1%E3%83%B3&srt=dlrank&qt=&pt=C&p=1")
